...
export const mockDocuments: BiddingDocument[] = [
  { id: 'doc-001', projectId: 'proj-001', fileName: '政务云平台投标文件-华为.pdf', fileType: 'pdf', fileSize: 5242880, uploadTime: '2026-06-10T14:30:00Z', signatureValid: true, encryptionValid: true, type: '投标文件', signed: true, archived: false, validationHistory: [{ step: 'format', passed: true, message: 'PDF格式校验通过', timestamp: '2026-06-10T14:30:05Z' }, { step: 'signature', passed: true, message: '数字签名验证有效', timestamp: '2026-06-10T14:30:07Z' }, { step: 'encryption', passed: true, message: '加密完整性验证通过', timestamp: '2026-06-10T14:30:09Z' }] },
  { id: 'doc-002', projectId: 'proj-001', fileName: '政务云平台投标文件-中建三局.pdf', fileType: 'pdf', fileSize: 8388608, uploadTime: '2026-06-10T16:00:00Z', signatureValid: true, encryptionValid: true, type: '投标文件', signed: true, archived: false, validationHistory: [{ step: 'format', passed: true, message: 'PDF格式校验通过', timestamp: '2026-06-10T16:00:05Z' }, { step: 'signature', passed: true, message: '数字签名验证有效', timestamp: '2026-06-10T16:00:07Z' }, { step: 'encryption', passed: true, message: '加密完整性验证通过', timestamp: '2026-06-10T16:00:09Z' }] },
  { id: 'doc-004', projectId: 'proj-002', fileName: '综合楼建设项目投标文件-中建五局.pdf', fileType: 'pdf', fileSize: 6291456, uploadTime: '2026-06-09T10:00:00Z', signatureValid: true, encryptionValid: true, type: '投标文件', signed: true, archived: false, validationHistory: [{ step: 'format', passed: true, message: 'PDF格式校验通过', timestamp: '2026-06-09T10:00:05Z' }, { step: 'signature', passed: true, message: '数字签名验证有效', timestamp: '2026-06-09T10:00:07Z' }, { step: 'encryption', passed: true, message: '加密完整性验证通过', timestamp: '2026-06-09T10:00:09Z' }] },
  { id: 'doc-006', projectId: 'proj-003', fileName: '医疗设备采购投标文件-东软集团.pdf', fileType: 'pdf', fileSize: 4194304, uploadTime: '2026-06-04T14:00:00Z', signatureValid: true, encryptionValid: true, type: '投标文件', signed: true, archived: false, validationHistory: [{ step: 'format', passed: true, message: 'PDF格式校验通过', timestamp: '2026-06-04T14:00:05Z' }, { step: 'signature', passed: true, message: '数字签名验证有效', timestamp: '2026-06-04T14:00:07Z' }, { step: 'encryption', passed: true, message: '加密完整性验证通过', timestamp: '2026-06-04T14:00:09Z' }], originalFailedDocId: 'fail-002' },
  { id: 'doc-007', projectId: 'proj-004', fileName: '智慧校园设备投标文件-科大讯飞.docx', fileType: 'docx', fileSize: 4194304, uploadTime: '2026-06-11T09:30:00Z', signatureValid: true, encryptionValid: true, type: '投标文件', signed: true, archived: false, validationHistory: [{ step: 'format', passed: true, message: 'DOCX格式校验通过', timestamp: '2026-06-11T09:30:05Z' }, { step: 'signature', passed: true, message: '数字签名验证有效', timestamp: '2026-06-11T09:30:07Z' }, { step: 'encryption', passed: true, message: '加密完整性验证通过', timestamp: '2026-06-11T09:30:09Z' }] },
  { id: 'doc-008', projectId: 'proj-004', fileName: '智慧校园设备投标文件-大华技术.pdf', fileType: 'pdf', fileSize: 3145728, uploadTime: '2026-06-11T11:00:00Z', signatureValid: true, encryptionValid: true, type: '投标文件', signed: false, archived: false, validationHistory: [{ step: 'format', passed: true, message: 'PDF格式校验通过', timestamp: '2026-06-11T11:00:05Z' }, { step: 'signature', passed: true, message: '数字签名验证有效', timestamp: '2026-06-11T11:00:07Z' }, { step: 'encryption', passed: true, message: '加密完整性验证通过', timestamp: '2026-06-11T11:00:09Z' }] },
  { id: 'doc-009', projectId: 'proj-005', fileName: '环境监测站投标文件-华为.pdf', fileType: 'pdf', fileSize: 2097152, uploadTime: '2026-05-27T09:00:00Z', signatureValid: true, encryptionValid: true, type: '投标文件', signed: true, archived: false, validationHistory: [{ step: 'format', passed: true, message: 'PDF格式校验通过', timestamp: '2026-05-27T09:00:05Z' }, { step: 'signature', passed: true, message: '数字签名验证有效', timestamp: '2026-05-27T09:00:07Z' }, { step: 'encryption', passed: true, message: '加密完整性验证通过', timestamp: '2026-05-27T09:00:09Z' }] },
  { id: 'doc-010', projectId: 'proj-005', fileName: '评标报告-环保项目.pdf', fileType: 'pdf', fileSize: 524288, uploadTime: '2026-05-30T15:00:00Z', signatureValid: true, encryptionValid: true, type: '评标报告', signed: true, archived: true, validationHistory: [{ step: 'format', passed: true, message: 'PDF格式校验通过', timestamp: '2026-05-30T15:00:05Z' }, { step: 'signature', passed: true, message: '数字签名验证有效', timestamp: '2026-05-30T15:00:07Z' }, { step: 'encryption', passed: true, message: '加密完整性验证通过', timestamp: '2026-05-30T15:00:09Z' }] },
  { id: 'doc-011', projectId: 'proj-005', fileName: '中标通知书-碧水源.pdf', fileType: 'pdf', fileSize: 204800, uploadTime: '2026-06-05T10:00:00Z', signatureValid: true, encryptionValid: true, type: '其他', signed: true, archived: false, validationHistory: [{ step: 'format', passed: true, message: 'PDF格式校验通过', timestamp: '2026-06-05T10:00:05Z' }, { step: 'signature', passed: true, message: '数字签名验证有效', timestamp: '2026-06-05T10:00:07Z' }, { step: 'encryption', passed: true, message: '加密完整性验证通过', timestamp: '2026-06-05T10:00:09Z' }] },
  { id: 'doc-012', projectId: 'proj-006', fileName: '政务系统运维投标文件-浪潮软件.pdf', fileType: 'pdf', fileSize: 786432, uploadTime: '2026-06-12T10:00:00Z', signatureValid: true, encryptionValid: true, type: '投标文件', signed: true, archived: false, validationHistory: [{ step: 'format', passed: true, message: 'PDF格式校验通过', timestamp: '2026-06-12T10:00:05Z' }, { step: 'signature', passed: true, message: '数字签名验证有效', timestamp: '2026-06-12T10:00:07Z' }, { step: 'encryption', passed: true, message: '加密完整性验证通过', timestamp: '2026-06-12T10:00:09Z' }] },
  { id: 'doc-013', projectId: 'proj-008', fileName: '市政道路改造投标文件-中建三局.pdf', fileType: 'pdf', fileSize: 7340032, uploadTime: '2026-06-07T13:00:00Z', signatureValid: true, encryptionValid: true, type: '投标文件', signed: true, archived: false, validationHistory: [{ step: 'format', passed: true, message: 'PDF格式校验通过', timestamp: '2026-06-07T13:00:05Z' }, { step: 'signature', passed: true, message: '数字签名验证有效', timestamp: '2026-06-07T13:00:07Z' }, { step: 'encryption', passed: true, message: '加密完整性验证通过', timestamp: '2026-06-07T13:00:09Z' }] },
  { id: 'doc-014', projectId: 'proj-008', fileName: '市政道路改造投标文件-迈瑞医疗.pdf', fileType: 'pdf', fileSize: 5242880, uploadTime: '2026-06-07T15:00:00Z', signatureValid: true, encryptionValid: true, type: '投标文件', signed: true, archived: false, validationHistory: [{ step: 'format', passed: true, message: 'PDF格式校验通过', timestamp: '2026-06-07T15:00:05Z' }, { step: 'signature', passed: true, message: '数字签名验证有效', timestamp: '2026-06-07T15:00:07Z' }, { step: 'encryption', passed: true, message: '加密完整性验证通过', timestamp: '2026-06-07T15:00:09Z' }] },
];
